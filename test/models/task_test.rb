...
class TaskTest < ActiveSupport::TestCase
  ...
  #  When two tasks have duplicate two worded titles:
  ...
  # When two tasks have duplicate hyphenated titles
  ...
  # When one of the task's title is a prefix of the other task's title
